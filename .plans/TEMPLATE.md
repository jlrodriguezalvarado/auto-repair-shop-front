...
- Repositories: auto-repair-shop-api | auto-repair-shop-front | both
...
- <Django (`auto-repair-shop-api`) owns transport; Angular (`auto-repair-shop-front`) consumes OpenAPI — note regeneration needs.>
