...
Keep aligned with `../auto-repair-shop-api/.agents/policies/qa.md`.

Companion policies: sibling `django-api.md` (in auto-repair-shop-api), `angular-frontend.md`, and `integration.md`.
